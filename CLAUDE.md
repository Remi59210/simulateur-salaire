...
- **Prochaines pistes :** blocs `tool-seo` (~600 mots) sous les outils encore sans contenu textuel ; image Open Graph dédiée (`og:image`) pour des partages sociaux riches.
