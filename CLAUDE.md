...
**📌 Prochain bloc de 3 (les plus courts restants, à remesurer avec `check.ps1` avant de commencer) :** `decoder-fiche-paie.html` (958 mots), `deductions-impots-enfants.html` (1 005), `frais-kilometriques-impots.html` (1 010).
