...
**📌 Prochain bloc de 3 (les plus courts restants, à remesurer avec `check.ps1` avant de commencer) :** `calculer-salaire-net-2025.html`, `deductions-impots-maison.html`, `statut-freelance-2026.html`. Le lot du 30/06 étant complet, la resoumission AdSense est possible dès maintenant ; poursuivre l'enrichissement en parallèle ne peut que renforcer le dossier.
